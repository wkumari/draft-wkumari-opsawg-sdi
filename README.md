...
Expires: October 9, 2020                                Juniper Networks
                                                          April 07, 2020
...
Kumari & Doyle           Expires October 9, 2020                [Page 1]

...
Kumari & Doyle           Expires October 9, 2020                [Page 2]

Internet-Draft            Secure Device Install               April 2020
...
1.  Introduction
   ...
   TFTP [RFC1350]) or something similar, is an unacceptable security
   risk for many operators, and so they send employees to remote
   locations to perform the initial configuration work; this costs, time
   and money.
...
Kumari & Doyle           Expires October 9, 2020                [Page 3]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020                [Page 4]

Internet-Draft            Secure Device Install               April 2020
...
2.1.  Example Scenario
   ...
   and Acme publishes it on their keyserver (in a public key
...
Kumari & Doyle           Expires October 9, 2020                [Page 5]

Internet-Draft            Secure Device Install               April 2020
...
3.1.  Device key generation
   ...
   Publication Server to be published.  The vendor's Certificate
   Publication Server should only accept certificates from the
   manufacturing facility, and which match vendor defined policies (for
   example, extended key usage, extensions, etc.)  Note that some
...
3.2.  Certificate Publication Server
   ...
   devices provide raw public keys and unique identifiers the
...
Kumari & Doyle           Expires October 9, 2020                [Page 6]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020                [Page 7]

Internet-Draft            Secure Device Install               April 2020
...
4.3.  Example Initial Customer Boot
   ...
   (Server-Name) or 150 (TFTP server address), contact the server listed
   in these DHCP options and downloads its config file.  Note that this
   is existing functionality (for example, Cisco devices fetch the
   config file named by the Bootfile-Name DHCP option (67)).
...
Kumari & Doyle           Expires October 9, 2020                [Page 8]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020                [Page 9]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020               [Page 10]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020               [Page 11]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020               [Page 12]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020               [Page 13]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020               [Page 14]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020               [Page 15]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020               [Page 16]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020               [Page 17]

Internet-Draft            Secure Device Install               April 2020
...
Kumari & Doyle           Expires October 9, 2020               [Page 18]
```
